...
import engineer from "../../assets/img/header-experience/engineer.gif";
import swStack from "../../assets/img/header-experience/sw-stack.png";
import { ExperienceProps } from '../experience/Experience';
import { TimelineMax } from 'gsap';
import styled from 'styled-components';
import './HeaderSoftwareEngineer.scss';
...
class HeaderSoftwareEngineer extends React.Component<ExperienceProps> {
  ...
  public render() {
    ...
    return (
        <div className="header-sw-eng-root--landscape position-relative overflow-hidden">
          {/* <h2 className="text-md-right text-center text-light mr-md-5">{this.props.experience.from} - {this.props.experience.to}</h2> */}
          <img id="sw-stack" className="header-sw-eng__sw-stack" src={swStack} alt="Software Stack"  ref={this.swStackRef}/>
          <div className="header-sw-eng-root--ground position-absolute fixed-top" />
