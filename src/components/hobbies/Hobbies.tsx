...
import martialArts from "../../assets/img/hobbies/martial-arts.png";
import music from "../../assets/img/hobbies/music.png";
import spearfishing from "../../assets/img/hobbies/spearfishing.png";
import cinema from "../../assets/img/hobbies/cinema.png";
import './Hobbies.scss';
      ...
      <React.Fragment>
        ...
        <div className="text-center">
          <Tween            
            ...
            progress={progress*5}
            playState="stop">
              <img className="hobbies__box" src={box} alt="Hobbies box" />
          </Tween>
          ...
          <Tween            
            ...
            playState="stop">
              <img className="hobbies__hobby" src={sport} alt="Sport hobby" />
          </Tween>
          <div className={"hobbies__hobby-description " + (this.adjustProgress(1.1, progress)==0?"out":"")}>
            <Tween            
          ...
          <Tween            
            ...
            playState="stop">
              <img className="hobbies__hobby hobbies__hobby-martial-arts" src={martialArts} alt="Martial Arts hobby" />
          </Tween>
          <div className={"hobbies__hobby-description " + (this.adjustProgress(2.1, progress)==0?"out":"")}>
            <Tween            
          ...
          <Tween            
            ...
            playState="stop">
              <img className="hobbies__hobby hobbies__hobby-martial-arts" src={music} alt="Music hobby" />
          </Tween>
          <div className={"hobbies__hobby-description " + (this.adjustProgress(3.1, progress)==0?"out":"")}>
            <Tween            
              from={{css: {className: "animate__animated animate__fadeOut"}}}
              to={{css: {className: "animate__animated animate__fadeIn"}}}
          ...
          <Tween            
            ...
            to={{ rotation:10, left:"10%", opacity: 1, className: "hobbies__hobby hobbies__hobby-spearfishing hobbies__hobby-spearfishing-end" }}
            progress={this.adjustProgress(4, progress)}
            playState="stop">
              <img className="hobbies__hobby hobbies__hobby-spearfishing" src={spearfishing} alt="Spearfishing hobby" />
          </Tween>
          <div className={"hobbies__hobby-description " + (this.adjustProgress(4.1, progress)==0?"out":"")}>
            <Tween            
              from={{css: {className: "animate__animated animate__fadeOut"}}}
          ...
          <Tween            
            from={{ rotation: 90, y: 0, opacity: 0 }}
            to={{ rotation:-10, left:"-10%", opacity: 1, className: "hobbies__hobby hobbies__hobby-cinema hobbies__hobby-cinema-end" }}
            progress={this.adjustProgress(5, progress)}
            playState="stop">
              <img className="hobbies__hobby hobbies__hobby-cinema" src={cinema} alt="Cinema hobby" />
          </Tween>
          <div className={"hobbies__hobby-description " + (this.adjustProgress(5.1, progress)==0?"out":"")}>
            <Tween            
              from={{css: {className: "animate__animated animate__fadeOut"}}}
              to={{css: {className: "animate__animated animate__fadeIn"}}}
