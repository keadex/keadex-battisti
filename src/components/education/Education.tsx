...
import parietalLobe from "../../assets/img/education/parietal-lobe.png";
import temporalLobe from "../../assets/img/education/temporal-lobe.png";
import cerebellum from "../../assets/img/education/cerebellum.png";
import happyHourBari from "../../assets/img/education/happy-hour-bari.png";
import sochild from "../../assets/img/education/sochild.png";
import marconi from "../../assets/img/education/marconi.png";
import brainGraph from "../../assets/img/education/brain-graph.png";
import jack from "../../assets/img/jack/jack.gif";
        ...
        <div className="row m-0">
          ...
          <div className="col-md-12 p-0">
            <Tween            
              ...
              playState="stop">
                <div>
                  <div className="education__cosmo" />
                  <div className="education__quote-container">
                  ...
                  <div className={"d-block d-lg-none text-center education__brain-container--mobile " + (this.adjustProgress(1, progress)!=0?"out":"")}>
                    <img className="education__brain-graph" src={brainGraph} alt="Brain Graph" />
                    <div className="education__brain-chart-banner">
                      <div id="text"><FormattedMessage id="ABOUT_ME.EDUCATION.BRAIN_GRAPH_BANNER" /></div>
                    </div>
                  </div>
                  
                  {/* SHOW INTERACTIVE BRAIN GRAPH ONLY ON DESKTOP */}
                  <div className={"d-none d-lg-block education__brain-container--desktop " + (this.adjustProgress(1, progress)!=0?"out":"") + (progress==0?" pointer-events-none":"")}>
          ...
          {/* HAPPY HOUR */}
          <div className={"col-sm-12 col-md-12 text-center education__container-element " + (this.adjustProgress(2, progress)==0?"out":"")}>
            <Tween            
              ...
              playState="stop">
                <div><img className="education__picture" src={happyHourBari} alt="Baresian happy hour" /></div>
            </Tween>          
            <Tween            
          ...
          {/* HIGH SCHOOL */}
          <div className={"col-sm-12 col-md-12 text-center education__container-element " + (this.adjustProgress(4, progress)==0?"out":"")}>
            <Tween            
              from={{css: {className: "animate__animated animate__fadeOutRight"}}}
              to={{css: {className: "animate__animated animate__fadeInLeft"}}}
              progress={this.adjustProgress(4, progress)}
              playState="stop">
                <div><img className="education__picture" src={marconi} alt="ITIS Guglielmo Marconi Bari" /></div>
            </Tween>          
            <Tween            
              from={{css: {className: "animate__animated animate__fadeOutDown"}}}
              to={{css: {className: "animate__animated animate__fadeInDown"}}}
          ...
          {/* UNIVERSITY */}
          <div className={"col-sm-12 col-md-12 text-center education__container-element " + (this.adjustProgress(6, progress)==0?"out":"")}>
            <Tween            
              from={{css: {className: "animate__animated animate__fadeOutRight"}}}
              to={{css: {className: "animate__animated animate__fadeInLeft"}}}
              progress={this.adjustProgress(6, progress)}
              playState="stop">
                <div><img className="education__picture" src={sochild} alt="SoChild" /></div>
            </Tween>          
            <Tween            
              from={{css: {className: "animate__animated animate__fadeOutDown"}}}
              to={{css: {className: "animate__animated animate__fadeInDown"}}}
          ...
          {/* JACK */}
          <div className={"col-sm-12 col-md-12 text-center education__container-element " + (this.adjustProgress(8, progress)==0?"out":"")}>
            <Tween            
              from={{css: {className: "animate__animated animate__fadeOutRight"}}}
              to={{css: {className: "animate__animated animate__fadeInLeft"}}}
              progress={this.adjustProgress(8, progress)}
              playState="stop">
                <div><img className="education__picture education__jack-avatar" src={jack} alt="Jack avatar" /></div>
            </Tween>          
            <Tween            
              from={{css: {className: "animate__animated animate__fadeOutDown"}}}
              to={{css: {className: "animate__animated animate__fadeInDown"}}}
