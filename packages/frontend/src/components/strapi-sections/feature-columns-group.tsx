import { ComponentSectionsFeatureColumnsGroup } from "../../model/autogenerated-graphql-strapi";
import Image from "../strapi-elements/image";


interface FeatureColumnsGroupProps {
  data: ComponentSectionsFeatureColumnsGroup
}

const FeatureColumnsGroup:React.FC<FeatureColumnsGroupProps> = ({ data }:FeatureColumnsGroupProps) => {
  return (
