...
import CustomLink from '../strapi-elements/custom-link';
import Video from '../strapi-elements/video';
import Image from "../strapi-elements/image";
import { ComponentSectionsFeatureRowsGroup } from "../../model/autogenerated-graphql-strapi";


interface FeatureRowsGroupProps {
  data: ComponentSectionsFeatureRowsGroup
}

const FeatureRowsGroup:React.FC<FeatureRowsGroupProps> = ({ data }:FeatureRowsGroupProps) => {
  return (
