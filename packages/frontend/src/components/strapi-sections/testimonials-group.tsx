...
import { ComponentSectionsTestimonialsGroup } from "../../model/autogenerated-graphql-strapi";

interface TestimonialsGroupProps {
  data: ComponentSectionsTestimonialsGroup
}

const TestimonialsGroup:React.FC<TestimonialsGroupProps> = ({ data }:TestimonialsGroupProps) => {
