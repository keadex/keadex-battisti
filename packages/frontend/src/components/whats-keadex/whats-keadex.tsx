...
import styles from './whats-keadex.module.scss';
...
const DosButton = dynamic(() => import('../dos-button/dos-button'));
...
//------------------ COMPONENT
const WhatsKeadex : React.FunctionComponent<WhatsKeadexProps> = props => {
  
  let listRefs:Map<string, RefObject<HTMLLIElement>> = new Map<string, RefObject<HTMLLIElement>>();
  listRefs.set(ListItem.experiment, React.createRef<HTMLLIElement>());
  listRefs.set(ListItem.modular, React.createRef<HTMLLIElement>());
  listRefs.set(ListItem.openSource, React.createRef<HTMLLIElement>());

  let svgPathRef:RefObject<SVGPathElement>[] = [
  ...
  let timelines:Map<string, MorphSVGTimeline>|undefined;
  let lastSubjectId:ListItem = ListItem.experiment;
  let listInterval:number = -1;
  let listIntervalTime:number = 5000;
  ...
  let initTimeline = () => {
    let subjects = [
      {
        fromSvgPath: {id: "experiment", path: experimentPath},
        toSvgPath: {id: "modular", path: modularPath}
      },
      {
        fromSvgPath: {id: "experiment", path: experimentPath},
        toSvgPath: {id: "openSource", path: openSourcePath}
      },
      {
        fromSvgPath: {id: "modular", path: modularPath},
        toSvgPath: {id: "experiment", path: experimentPath}
      },
      {
        fromSvgPath: {id: "modular", path: modularPath},
        toSvgPath: {id: "openSource", path: openSourcePath}
      ...
      {
        fromSvgPath: {id: "openSource", path: openSourcePath},
        toSvgPath: {id: "experiment", path: experimentPath}
      },
      {
        fromSvgPath: {id: "openSource", path: openSourcePath},
    ...
    timelines = generateMorphSVGTimelines(svgPathRef, subjects);
  }

  //------------ animateWhatsKeadex
  let animateWhatsKeadex = (toSubjectId:ListItem) => {
    if (timelines == undefined) initTimeline();
    if (toSubjectId !== lastSubjectId){
      var subjects:string = lastSubjectId + "_" + toSubjectId;
      listRefs.get(lastSubjectId)!.current!.className="";
      listRefs.get(toSubjectId)!.current!.className=styles["active"];
      lastSubjectId = toSubjectId;
      timelines!.get(subjects)!.timeline.restart();
    }
  }

  //------------ stoptWhatsKeadexLoop
  let stoptWhatsKeadexLoop = () => {
    if (listInterval != -1) clearInterval(listInterval);    
  }

  //------------ onWhatsKeadexHover
  let onWhatsKeadexHover = (toSubjectId:ListItem) => {
    stoptWhatsKeadexLoop();
    animateWhatsKeadex(toSubjectId)
  }
    
  //------------ startWhatsKeadexLoop
  let startWhatsKeadexLoop = () => {
    listInterval = setInterval(()=>{
      var nextListItem:string = Object.keys(ListItem)[(Object.keys(ListItem).indexOf(lastSubjectId) + 1) % Object.keys(ListItem).length];
      animateWhatsKeadex(ListItem[nextListItem as keyof typeof ListItem])
    }, listIntervalTime);
  }

  return (
    <div className={`${styles["whats-keadex"]}`}>
        ...
        <div className="col-12 col-md-3 text-center">
          <ScrollAnimation scrollableParentSelector={"#"+PAGE_ROOT_ID} animateIn='animate__fadeInUp' animateOnce>
            <svg id="svg" height="100%" viewBox="0 0 260 300" >
              ...
              <path filter="url(#shadow-6dp)" ref={svgPathRef[0]} id="target1" d={experimentPath[0]}></path>
              <path filter="url(#shadow-6dp)" ref={svgPathRef[1]} id="target2" d={experimentPath[1]}></path>
              <path filter="url(#shadow-6dp)" ref={svgPathRef[2]} id="target3" d={experimentPath[2]}></path>
            </svg>
          </ScrollAnimation>
        </div>
        <div className="col-12 col-md-9 mt-5 mt-md-0 pl-0 pl-md-5">
          <ScrollAnimation scrollableParentSelector={"#"+PAGE_ROOT_ID} animateIn='animate__fadeInUp' animateOnce>
            <FormattedMessage id="HOME.TEXT_WHY" values={props.formatMessageValues}/>
          </ScrollAnimation>
          <ul>
            <li className={`${styles["active"]}`} ref={listRefs.get(ListItem.experiment)} onClick={()=>{onWhatsKeadexHover(ListItem.experiment)}} onMouseOver={()=>{onWhatsKeadexHover(ListItem.experiment)}} onMouseLeave={()=>{startWhatsKeadexLoop()}}>
              <ScrollAnimation scrollableParentSelector={"#"+PAGE_ROOT_ID} animateIn='animate__fadeInUp' animateOnce>
                <FormattedMessage id="HOME.EXPERIMENT" />
              </ScrollAnimation>
            </li>
            <li ref={listRefs.get(ListItem.modular)} onClick={()=>{onWhatsKeadexHover(ListItem.modular)}} onMouseOver={()=>{onWhatsKeadexHover(ListItem.modular)}} onMouseLeave={()=>{startWhatsKeadexLoop()}}>
              <ScrollAnimation scrollableParentSelector={"#"+PAGE_ROOT_ID} animateIn='animate__fadeInUp' animateOnce>
                <FormattedMessage id="HOME.MODULAR" />
              </ScrollAnimation>
            </li>
            <li ref={listRefs.get(ListItem.openSource)} onClick={()=>{onWhatsKeadexHover(ListItem.openSource)}} onMouseOver={()=>{onWhatsKeadexHover(ListItem.openSource)}} onMouseLeave={()=>{startWhatsKeadexLoop()}}>
              <ScrollAnimation scrollableParentSelector={"#"+PAGE_ROOT_ID} animateIn='animate__fadeInUp' animateOnce>
      ...
      <ScrollAnimation scrollableParentSelector={"#"+PAGE_ROOT_ID} animateIn='animate__fadeInUp' animateOnce>
        <div className={`m-0 mt-6 mt-md-7 text-center ${styles["whats-keadex__kealab"]}`}>
          <div className={`${styles["whats-keadex__kealab-title"]}`}>
            $$\&nbsp;&nbsp;&nbsp;$$\&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$$\&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$$\&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br/>$$&nbsp;|&nbsp;$$&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$$&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$$&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br/>$$&nbsp;|$$&nbsp;&nbsp;/&nbsp;$$$$$$\&nbsp;&nbsp;&nbsp;$$$$$$\&nbsp;&nbsp;$$&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$$$$$$\&nbsp;&nbsp;$$$$$$$\&nbsp;&nbsp;<br/>$$$$$&nbsp;&nbsp;/&nbsp;$$&nbsp;&nbsp;__$$\&nbsp;&nbsp;\____$$\&nbsp;$$&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\____$$\&nbsp;$$&nbsp;&nbsp;__$$\&nbsp;<br/>$$&nbsp;&nbsp;$$&lt;&nbsp;&nbsp;$$$$$$$$&nbsp;|&nbsp;$$$$$$$&nbsp;|$$&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$$$$$$$&nbsp;|$$&nbsp;|&nbsp;&nbsp;$$&nbsp;|<br/>$$&nbsp;|\$$\&nbsp;$$&nbsp;&nbsp;&nbsp;____|$$&nbsp;&nbsp;__$$&nbsp;|$$&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$$&nbsp;&nbsp;__$$&nbsp;|$$&nbsp;|&nbsp;&nbsp;$$&nbsp;|<br/>$$&nbsp;|&nbsp;\$$\\$$$$$$$\&nbsp;\$$$$$$$&nbsp;|$$$$$$$$\\$$$$$$$&nbsp;|$$$$$$$&nbsp;&nbsp;|<br/>\__|&nbsp;&nbsp;\__|\_______|&nbsp;\_______|\________|\_______|\_______/&nbsp;                </div>
          <div className={`${styles["whats-keadex__kealab-content"]}`}><FormattedMessage id="HOME.TEXT_KEALAB" values={props.formatMessageValues}/></div>
          <DosButton href={KEA_LAB_URL}><FormattedMessage id="HOME.SHOW_KEALAB" /></DosButton>
        </div>
      </ScrollAnimation>
    </div>
  );
