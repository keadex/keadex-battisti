...
import { ArchitectureModuleFeatue, ArchitectureModuleFeature } from '../architecture-module-feature/architecture-module-feature';
              ...
              (currentUrl.indexOf("#"+module.moduleId) != -1)&&<div key={module.moduleId} data-modulename={module.moduleId} className={(currentUrl.indexOf("#"+module.moduleId) == -1)?"d-none":""}>
                {module.logo && (
                  <div className="mt-6 mb-4 w-100 text-center">
                    <img className={`${styles["architecture__module-logo"]}`} src={getStrapiMedia(module.logo.url)!} />
                  </div>
                )}
                      ...
                      <>
                        <div className="mt-5" ref={moduleFeaturesRef} id="module-features">
                          ...
                          {module.features.map((feature)=>{
                            return <ArchitectureModuleFeature feature={feature!} key={feature!.id} />
                          })}
                        </div>
                      </>
                    )}
